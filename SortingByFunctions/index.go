 ...
 * @Date         : 2022-12-09 17:24:04
 * @LastEditors  : eug yyh3531@163.com
 * @LastEditTime : 2022-12-09 17:58:10
 * @FilePath     : /GO/SortingByFunctions/index.go
 * @Description  : 使用函数自定义排序
 *
...
func main() {
	...
	// 类似的，参照这个例子，创建一个自定义类型， 为它实现 Interface 接口的三个方法，

 ...
 * @Date         : 2022-12-09 15:26:05
 * @LastEditors  : eug yyh3531@163.com
 * @LastEditTime : 2022-12-09 15:42:24
 * @FilePath     : /GO/WorkerPools/index.go
...
func worker(id int, jobs <-chan int, results chan<- int) {
	for j := range jobs {
		fmt.Println("workerID:", id, "started  job:", j)
		time.Sleep(time.Second)
		fmt.Println("workerID:", id, "finished job:", j)
		results <- j * 2
	}
}
